---
title: 帮助我们
description: 星闪工具箱,星闪工具,星闪开发,星闪,NearLink,NearLink ToolBox,如何为我们项目做出贡献
---

import { Aside } from '@astrojs/starlight/components';
import { Card, CardGrid, LinkCard } from '@astrojs/starlight/components';

<Aside type="caution" title="注意">请不要以任何不合理的理由骚扰我们所有团队成员, 这是最基本的社区礼貌!</Aside>
...
请阅读我们的[行为准则](https://github.com/MiraHikari/nearlink-firmwares/blob/main/.github/CODE_OF_CONDUCT.md)。
